...
function processPost(post) {
  ...
  var fullPath =
    ...
    '-' +
    getPaddedMonthNumber(postDate.getDate() + 1) +
    '-' +
    getPaddedMonthNumber(postDate.getHours() + 1) +
    getPaddedMonthNumber(postDate.getMinutes() + 1) +
    getPaddedMonthNumber(postDate.getSeconds() + 1) +
    '-' +
    slug;
